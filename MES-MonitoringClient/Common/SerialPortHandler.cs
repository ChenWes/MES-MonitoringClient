...
{
    public class SerialPortHandler : MarshalByRefObject, IDisposable
    {
        /// <summary>
        /// Field _syncRoot.
        /// </summary>
        ...
        public SerialPortHandler(string portName = "COM1", int baudRate = 9600, Parity partity = Parity.None, int dataBits = 8, StopBits stopBits = StopBits.One)
        {
        ...
        /// <summary>
        /// Finalizes an instance of the <see cref="SerialPortHandler" /> class.
        /// </summary>
        ~SerialPortHandler()
        {
            this.Dispose(false);
